...
SECRET_KEY = '1#=fu-1sq5$z+*se!2=xkhv2#q0=yul8lvhb1w390btk8il%=2'
...
MIDDLEWARE = [
    ...
    # 모든 middleware들은 인풋과 아웃풋이 무조건 존재
    # 요청이 들어오면 여기 있는 모든 middleware를 다 거쳐간 후 나간 것이 view에 간다.
    'corsheaders.middleware.CorsMiddleware',    # CORS 정책을 걸러내고 밑으로 보낼께
...
#     # 이 안에 있는 애들은 okay를 해줄 것이다.
#     "http://127.0.0.1:8080",
#     "http://my-cool-site.com"
# ]
# 이게 원래 쓰는 방법이지만 일단은 모두 allow해보자
